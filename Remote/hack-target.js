// Based on: https://github.com/66Ton99/bitburner-scripts/blob/main/Remote/hack-target.js
/** @param {NS} ns
...
export async function main(ns) {
    ...
    const suppressMisfireToasts = silentMisfires || description == "FarmXP";
    ...
    do {
        ...
        if (stolen == 0 && !suppressMisfireToasts)
